      ...
      >
        ...
        <View style={styles.notifySection}>
          ...
          <View style={styles.notifyPills}>
            ...
            >
              ...
              />
              <Text style={[styles.notifyPillText, notifyMode === 'Once' && styles.notifyPillTextActive]}>
                Once
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              />
              <Text style={[styles.notifyPillText, notifyMode === 'Everyday' && styles.notifyPillTextActive]}>
                Everyday
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={{ alignItems: 'flex-end' }}>
            ...
            <View style={[styles.statBadge, { backgroundColor: '#FFFDE7' }]}>
              ...
              <Text style={[styles.statBadgeText, { color: '#795548' }]}>
                ₹{MARKET_PRICE}/gm
              </Text>
            </View>
          </View>
        ...
        <View style={styles.chartWrapper}>
          <Svg width={CHART_WIDTH} height={CHART_HEIGHT}>
            ...
            <Path d={area} fill="url(#goldGrad2)" />
            <Path
              d={line}
              fill="none"
              stroke="#F5C518"
